...
public class InventoryDatabaseHelper extends SQLiteOpenHelper {
    ...
    public long createUser(String email, String password) {
        ...
        String scrambledPassword = BCrypt.hashpw(password, BCrypt.gensalt(12));
        values.put(COLUMN_PASSWORD, scrambledPassword);
    ...
    public boolean verifyUser(String email, String password) {
        // Get the scrambled password from database
        String storedScrambledPassword = getStoredPasswordHash(email);
        // Check if the entered password matches the scrambled one
        return BCrypt.checkpw(password, storedScrambledPassword);
    }
